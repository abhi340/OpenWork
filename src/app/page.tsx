...
export default function Dashboard() {
  ...
  // Global Power-User Hotkeys (Z, S, P, B, N)
  useEffect(() => {
    ...
    <div className="flex h-full bg-white dark:bg-zinc-950 text-slate-900 dark:text-zinc-100">
      ...
      <div className="flex-1 p-4 sm:p-6 md:p-8 overflow-y-auto border-r border-slate-200 dark:border-zinc-800/80 min-w-0">
        ...
        <div className="mb-6 pb-4 border-b border-slate-200/80 dark:border-zinc-800/80 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          {/* Action Toolbar - Touch-friendly & horizontally scrollable on mobile */}
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1 flex-nowrap md:flex-wrap">
            ...
            <button
              ...
              title="Clean morning rollover and backlog resolver"
            >
              <Sunrise size={13} />
              <span>Triage</span>
            </button>
            ...
            <button
              ...
              title="Enter full-screen Zen Focus HUD mode"
            >
              <Maximize2 size={13} />
              <span>Zen HUD</span>
            </button>
            ...
            <button
              ...
              title="Load role workflow blueprint (CEO, Engineer, Sales, Intern)"
            >
            ...
            <button
              ...
              title="Generate 1-click standup report"
            >
              <FileCheck2 size={13} />
              <span>Standup</span>
            </button>
            ...
            <button
              ...
              title="Export Proof of Work Portfolio"
            >
              <Award size={13} />
              <span>Portfolio</span>
            </button>
